...
const steps = [
  { zh: "止血", statement: "现金流比利润还要重要。" },
  { zh: "修理", statement: "改变人、方法和战场。" },
  { zh: "重回增长", statement: "找到价值点，集中资源投入。" },
  { zh: "平台化", statement: "把成功模式标准化、复制和放大。" },
];
...
export default function PlaybooksPage() {
  return (
    <main>
      <Header path="/playbooks" />
      <section className="method-hero shell">
        <p className="eyebrow">Adam Cui 四步法</p>
        <h1>先活下来，<br />再长起来。</h1>
